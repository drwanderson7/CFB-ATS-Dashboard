...
function renderPicksDetail(){
  ...
  wrap.innerHTML=activeEntries().map(e=>{
    ...
    const rowsOrEmpty=entries.length?rows:`<p class="note" style="margin:6px 0 0;">No picks yet. Select a team from This Week or All Games while this entry is active.</p>`;
